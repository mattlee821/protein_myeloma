...
write.table(data_exposure, "analysis/005_colocalization/data_exposure/data_exposure.txt",
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
snps <- unique(data_exposure$SNP)
write.table(snps, "analysis/005_colocalization/data_exposure/snplist-exposure.txt",
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
