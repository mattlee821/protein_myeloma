...
harmonise_data_list <- fread("analysis/003_colocalization/results/ieu-b-4957/harmonise_data.txt")
...
for (i in 834:length(harmonise_data_list)){
...
write.table(table_master, "analysis/003_colocalization/results/ieu-b-4957/001_coloc_results_missing.txt", 
