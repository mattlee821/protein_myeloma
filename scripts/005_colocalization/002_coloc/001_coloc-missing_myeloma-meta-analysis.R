...
harmonise_data_list <- fread("analysis/003_colocalization/results/myeloma-meta-analysis/harmonise_data.txt")
...
for (i in 1448:length(harmonise_data_list)){
...
write.table(table_master, "analysis/003_colocalization/results/myeloma-meta-analysis/001_coloc_results_missing.txt", 
