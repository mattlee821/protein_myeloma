...
data_outcome <- fread("analysis/005_colocalization/data_outcome/data_outcome1.txt")
...
write.table(data_harmonise, "analysis/005_colocalization/data_harmonise/data_harmonise-outcome1.txt",
