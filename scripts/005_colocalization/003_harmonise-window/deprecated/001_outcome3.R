...
data_outcome <- fread("analysis/005_colocalization/data_outcome/data_outcome3.txt")
...
write.table(data_harmonise, "analysis/005_colocalization/data_harmonise/data_harmonise-outcome3-new.txt",
