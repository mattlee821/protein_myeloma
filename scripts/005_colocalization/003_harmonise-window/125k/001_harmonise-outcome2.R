...
data_outcome <- fread("analysis/005_colocalization/data_outcome/125k/data_outcome2.txt")
...
write.table(data_harmonise, "analysis/005_colocalization/data_harmonise/125k/data_harmonise-outcome2.txt",
