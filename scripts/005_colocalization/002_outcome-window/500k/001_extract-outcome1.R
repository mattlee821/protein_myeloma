...
# data ====
snps <- fread("analysis/005_colocalization/data_exposure/500k/snplist-exposure.txt")
snps <- unique(snps$x)
...
write.table(data_outcome, "analysis/005_colocalization/data_outcome/500k/data_outcome1.txt",
